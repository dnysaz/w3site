...
<body class="bg-white antialiased">
    <div class="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div class="absolute inset-0 flex items-center justify-center select-none pointer-events-none">
            <h1 class="text-[25rem] md:text-[35rem] font-[1000] text-slate-100 leading-none">
                404
            </h1>
        </div>
        ...
        <div class="relative z-10 text-center">
            ...
            <h2 class="text-5xl md:text-7xl font-[1000] text-slate-900 tracking-tighter italic mb-8">
                Halaman <span class="text-blue-600">Tidak Ditemukan!</span>
            </h2>
            ...
            <div class="mt-12 opacity-30 text-[9px] font-bold text-slate-400 uppercase tracking-widest">
                w3site.id
            </div>
        </div>
    </div>
